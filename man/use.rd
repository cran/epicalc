...
\details{'use' reads in datasets from Dbase (.dbf), Stata (.dta), SPSS(.sav), EpiInfo(.rec) and Comma separated value(.csv) formats as well as those come with 'pakage:datasets' in R. The data frame is saved in memory as '.data' and automatically attached to the search path. This setting is the basis for other commands of 'epicalc' including 'des', 'summ', 'recode', 'label.var' etc. 
...
\arguments{
	...
	\item{clear}{equal to 'detach.all.data()' before reading in the data set and attaching it to the search path}
}
\author{Virasakdi Chongsuvivatwong
	\email{ <cvirasak@medicine.psu.ac.th>}
}
\seealso{'read.table', 'read.dta', 'read.SPSS', etc and 'detach.all.data'}
\examples{
# data(BOD)
library(foreign)
